...
namespace XamCam
{
	public static class APIService
	{
		...
		public static async Task<string> StartRecordingAsync(string deviceId) =>
			await GetDataObjectFromAPI<string>($"{AppConstants.StartRecordingUrl}{deviceId}").ConfigureAwait(false);

		public static async Task<string> StopRecordingAsync(string deviceId) =>
			await GetDataObjectFromAPI<string>($"{AppConstants.StopRecordingUrl}{deviceId}").ConfigureAwait(false);
