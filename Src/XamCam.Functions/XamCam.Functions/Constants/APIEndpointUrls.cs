...
{
	static class APIEndpointUrls
	{
		public const string CosmosDb = "https://xamcamcosmosdb.documents.azure.com:443/";
		...
		public const string AMSEndpoint = "http://xamcammediaservice.streaming.mediaservices.windows.net/";
		public const string HostName = "HomeCam-IoT.azure-devices.net";
		public const string IotHubD2CEndpoint = "messages/events";
		public const string GetIoTHubConenctionStringAPI = "AddDevice";
	}
}