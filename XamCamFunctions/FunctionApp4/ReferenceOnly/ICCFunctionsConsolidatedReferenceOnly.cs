...
//        //VERSION 1
//        //DOES NOT WORK
//        //IT SEEMS THAT THE SDK DOES NOT RECOGNIZE/JSON PROPERTY TAGS 
//        // HOWEVER THE .core sdk VERSION DOES RECOGNIZE THEM
...
//        //    var myUploadedFile = await req.Content.ReadAsAsync<XamCamAccount>();
...
//        //    ////TAKE THE LIST AND THEN ADD IT TO JSON AND SEND IT BACK!
//        //    //log.Info("Partial Return List with One Object processed a request.");
//        //    //string jsonResult = JsonConvert.SerializeObject(myUploadedFile);
//        //    //var httpRM = new HttpResponseMessage(HttpStatusCode.OK);
//        //    // httpRM.Content = new StringContent(jsonResult, System.Text.Encoding.UTF8, "application/json");
//        //    //return httpRM;
//        //}
...
//        //[FunctionName("DeleteDataFromCosmos")]
//        //public static async Task<HttpResponseMessage> RunDeleteDataFromCosmos([HttpTrigger(AuthorizationLevel.Anonymous, "post", "delete", Route = null)]HttpRequestMessage req, TraceWriter log)
//        //{
//        //    var myUploadedFile = await req.Content.ReadAsAsync<XamCamAccount>();
...
//        //public static async Task<HttpResponseMessage> RunGetDataFromCosmos([HttpTrigger(AuthorizationLevel.Anonymous, "post", "get", Route = null)]HttpRequestMessage req, TraceWriter log)
//        //{
//        //    var myUploadedFile = await req.Content.ReadAsAsync<XamCamAccount>();
...
//        //[FunctionName("PostToCosmosConvertToObject")]
//        //public static async Task<HttpResponseMessage> RunPostToCosmosConvertToObject([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = null)]HttpRequestMessage req, TraceWriter log)
//        //{

//        //    var myUploadedFile = await req.Content.ReadAsAsync<XamCamAccount>();

//        //    XamCamAccount tempXamCamAccount = new XamCamAccount() {
//        //        Id = myUploadedFile.Id,
//        //        Email = myUploadedFile.Email,
//        //        BlobContainer = myUploadedFile.BlobContainer,
//        //        Password = myUploadedFile.Password,
//        //        SaltedPassword = myUploadedFile.SaltedPassword
...
//        //[FunctionName("DeleteDataFromCosmosConvertToObject")]
//        //public static async Task<HttpResponseMessage> RunDeleteDataFromCosmosConvertToObject([HttpTrigger(AuthorizationLevel.Anonymous, "post", "delete", Route = null)]HttpRequestMessage req, TraceWriter log)
//        //{
//        //    var myUploadedFile = await req.Content.ReadAsAsync<XamCamAccount>();
...
//        //[FunctionName("GetDataFromCosmosConvertToObject")]
//        //public static async Task<HttpResponseMessage> RunGetDataFromCosmosConvertToObject([HttpTrigger(AuthorizationLevel.Anonymous, "post", "get", Route = null)]HttpRequestMessage req, TraceWriter log)
//        //{
