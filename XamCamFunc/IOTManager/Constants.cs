...
namespace IOTManager
{
    public static class Constants
    {
        public static class IotHubConfig
        {
            ...
            public static string connectionString = $"HostName=HomeCam-IoT.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=SF7KzXbqc+zq0l7YyVtvyQI2KR9OsGrEqzaXLWwq86c=";
